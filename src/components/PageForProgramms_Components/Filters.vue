...
const itemsOrganizations = ['Агрофизический научно-исследовательский институт', 'Академия машиностроения имени Ж.Я. Котина', 'Академия транспортных технологий', 'Арктический и антарктический научно-исследовательский институт']

const itemsProgramms = ['Экономика и бухгалтерский учет (по отраслям)', 'Бизнес-аналитика и большие данные (Master in Business Analytics and Big Data - MiBA)', 'Банкротное право']

const itemsLevelEducation = ['Бакалавр', 'Магистратура']
