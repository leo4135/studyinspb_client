    ...
    <div class="wrapper">
      <div class="container_for_logo_and_main_info">
        ...
        <div class="container_for_info">
          ...
          <div class="container_for_attr_cards">
            <div class="container_for_text_and_logo">
              <div class="group_for_svg_and_count">
                ...
                <span> {{ currentOrganization.countPrograms.totalCount }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs"> образовательных <br> программ</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.mag > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.mag }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs"> программ <br> магистратуры</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.bak > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.bak }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs"> программ <br> бакалавриата</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.asp > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.asp }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs">программ <br> аспирантуры</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.spec > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.spec }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs">программ <br> специалитета</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.spo > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.spo }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs">программ <br> СПО</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.dpo > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.dpo }} </span>
              </div>
              <span class="container_for_text_and_logo_education_programs">программ <br> ДПО</span>
            </div>

            <div class="container_for_text_and_logo" v-if="currentOrganization.countPrograms.bvo > 0">
              <div class="group_for_svg_and_count_other">
                <div class="fake_svg"></div>
                <span> {{ currentOrganization.countPrograms.bvo }} </span>
              </div>
          ...
          <div class="container_for_buttons">
            ...
            <a style="display: none;">новости вуза</a>
          </div>
        </div>
      </div>
      ...
      <div class="container_for_media_and_map">
        <div class="container_for_media">
          ...
          <a style="display: none;">подробнее о вузе</a>
        </div>
...
.style_for_items_nav_menu:hover {
  cursor: pointer;
  opacity: 0.6;
}
...
.container_for_logo_and_main_info h1 {
  text-align: center;
}
.container_for_attr_cards {
  justify-content: center;
